...
public interface Graph {
     ...
     * @return true this graph contains the edge {vertex1, vertex2}, false
     * of the edge is not in this graph
     * @throws RuntimeException if either vertex1 or vertex2 is not in 
     * this graph
     */
     ...
     * sequence consisting of the degree of each vertex, sorted from largest
     * to smallest.
     ...
     * Makes the capacity either larger or smaller, depending on the value 
     * of newCapacity.
