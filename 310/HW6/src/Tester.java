...
public class Tester {
    public static void main(String[] args) {
        ...
        tests = new ArrayList<>();
        runCommonTests(tests, new SLinkedStackOfInteger());
     ...
     */
    public static void runCommonTests(ArrayList<TestResult> tests, StackOfIntegerInterface stack){
    ...
    public static void runConstructorTests(ArrayList<TestResult> stack){
        ...
        StackOfIntegerInterface buffer;

        // Constructing DLinkedBuffer
        buffer = new SLinkedStackOfInteger();
    ...
    public static void runInitializeTests(ArrayList<TestResult> tests, StackOfIntegerInterface stack){
        stack.clear();
    ...
    public static void runPushPopTests(ArrayList<TestResult> tests, StackOfIntegerInterface stack){
        Integer result;
        stack.clear();
        stack.push(1);
    ...
    public static void runClearTests(ArrayList<TestResult> tests, StackOfIntegerInterface stack){
        stack.clear();
    ...
    public static void runIsEmptyTests(ArrayList<TestResult> tests, StackOfIntegerInterface buffer){
        buffer.clear();
    ...
    public static void runExceptionTests(ArrayList<TestResult> tests, StackOfIntegerInterface buffer){
